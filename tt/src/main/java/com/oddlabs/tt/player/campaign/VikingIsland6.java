...
public final strictfp class VikingIsland6 extends Island {
	private final ResourceBundle bundle = ResourceBundle.getBundle("i18n." + VikingIsland6.class.getName());
	...
	public final void init(NetworkSelector network, GUIRoot gui_root) {
		...
		GameNetwork game_network = startNewGame(network, gui_root, 256, Landscape.NATIVE, .75f, 1f, .5f, 13462, 6, VikingCampaign.MAX_UNITS, ai_names);
