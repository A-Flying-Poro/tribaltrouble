...
public final strictfp class RegistrationForm extends Form implements RegisterProgressFormListener {
	...
	public RegistrationForm(GUIRoot gui_root, boolean online, MainMenu main_menu) {
		...
		ResourceBundle bundle = ResourceBundle.getBundle("i18n." + RegistrationForm.class.getName());
		// headline
		...
		if (online) {
			...
			button_cancel_quit = new HorizButton(Utils.getBundleString(ResourceBundle.getBundle("i18n." + MainMenu.class.getName()), "quit"), BUTTON_WIDTH);
	...
	public final void registrationCompleted() {
		...
		remove();
		ResourceBundle bundle2 = ResourceBundle.getBundle("i18n." + RegisterProgressForm.class.getName());
