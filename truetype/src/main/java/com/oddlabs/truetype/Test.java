...
public final strictfp class Test {
	...
	public final static void main(String[] args) {
		try {
			...
			Font src_font = Font.createFont(Font.TRUETYPE_FONT, font_is);
			Font font = src_font.deriveFont(14f);
...
System.out.println("total_time = " + total_time);
	...
	private final static void pixelDataFromString(int width, int height, String str, Font font, int[] pixels, LineBreakMeasurer measurer) {
