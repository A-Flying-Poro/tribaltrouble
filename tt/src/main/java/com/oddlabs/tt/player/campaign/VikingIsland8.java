...
import com.oddlabs.tt.trigger.campaign.*;
...
public final strictfp class VikingIsland8 extends Island {
	private final ResourceBundle bundle = ResourceBundle.getBundle("i18n." + VikingIsland8.class.getName());
	...
	protected final void start() {
		...
		// Insert viking men
		ResourceBundle player_bundle = ResourceBundle.getBundle("i18n." + Player.class.getName());
