	...
	public NativeCursor(GLIntImage image_16_1, int offset_x_16_1, int offset_y_16_1,
		...
		try {
			if (max_size < 32 && max_size >= 16 && alpha_bits >= 1)
				native_cursor = new Cursor(image_16_1.getWidth(), image_16_1.getHeight(), offset_x_16_1, offset_y_16_1, 1, image_16_1.createCursorPixels(), null);
			else if (max_size >= 32) {
				if (alpha_bits == 8)
					native_cursor = new Cursor(image_32_8.getWidth(), image_32_8.getHeight(), offset_x_32_8, offset_y_32_8, 1, image_32_8.createCursorPixels(), null);
				else if (alpha_bits == 1)
					native_cursor = new Cursor(image_32_1.getWidth(), image_32_1.getHeight(), offset_x_32_1, offset_y_32_1, 1, image_32_1.createCursorPixels(), null);
			}
