			...
			if (i < 2) {
				for (x_block = 0, x = 0; x_block < (1<<i); x_block++) {
					for (y_block = 0, y = 0; y_block < (1<<i); y_block++) {
						...
						v5 = 0.25f*(v1 + v2 + v3 + v4) + Tools.gaussify(random.nextFloat(), 0.25f)*amp - amp_half;
			...
			if (i < 2) {
				for (x_block = 0, x = 0; x_block < (1<<i); x_block++) {
					for (y_block = 0, y = 0; y_block < (1<<i); y_block++) {
						...
						v8 = 0.25f*(v1 + v3 + v5 + v6) + Tools.gaussify(random.nextFloat(), 0.25f)*amp - amp_half;
						v9 = 0.25f*(v1 + v2 + v5 + v7) + Tools.gaussify(random.nextFloat(), 0.25f)*amp - amp_half;
