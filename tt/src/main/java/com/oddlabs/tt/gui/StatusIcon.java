...
//		label.setPos(icon.getWidth(), (getHeight() - label.getFont().getHeight())/2);
	...
	public final void appendToolTip(ToolTipBox tool_tip_box) {
		String tooltip_str = Utils.getBundleString(ResourceBundle.getBundle("i18n." + StatusIcon.class.getName()), "max", new Object[]{tooltip, new Integer(counter.getMaxSupplies())});
